...
class DTMQN:
    def __init__(self, env, Policy, config):
        ...
        self.dynamic_memory_max_size = config['dynamic_memory_max_size']
        self.dynamic_memory_min_size = config['number_of_state_bits_ta']
...
"""
    ...
    def test(self, nr_of_steps):
        ...
        if self.q_vals[0] > 200:
            a = 2
        if self.q_vals[1] > 200:
            a = 2
